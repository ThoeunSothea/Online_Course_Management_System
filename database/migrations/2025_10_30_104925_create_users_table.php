...
return new class extends Migration
{
    ...
    {
        // Create tbl_users if not exists
        ...
        // Create tbl_password_reset_tokens if not exists
        if (!Schema::hasTable('tbl_password_reset_tokens')) {
        ...
        // Create tbl_sessions if not exists
        if (!Schema::hasTable('tbl_sessions')) {
